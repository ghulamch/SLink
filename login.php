...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $remember_me = isset($_POST['remember-me']) ? true : false; // Check if "Remember Me" is checked
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $_SESSION['username'] = $uname; // Store the username in session
            $_SESSION['user_id'] = $user['id']; // Store the username in session

            if ($remember_me) {
                // Set a cookie if "Remember Me" is checked
                $cookie_value = $user['id']; // Use user ID as a cookie value
                setcookie("user_id", $cookie_value, time() + (86400 * 30), "/"); // Set cookie for 30 days
            }

            $alert_message = '<div class="alert alert-success" role="alert">Login successful!</div>';
        ...
        $alert_message = '<div class="alert alert-danger" role="alert">Username not found!</div>';
    }
}
?>
...
<head>
    ...
    <title>Login | Shortener Link</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to SLink! 👋</h4>
